...
\begin{abstract}
 Firstly I'd owe much gratitude to both of my supervisors: Sue Fletcher-Watson and Helen Pain for your boundless support and encouragement. \\
Sue for you're mountains of feedback throughout the entire project, many meeting minutes, help with organization, writing plans and being patient with the somewhat initial resistance I have towards those evil thing and in-spite of your heavy schedule answering my limitless questions and random email tangents on various unrelated aspects of Autism! \\
Secondly, Helen Pain, for being on-call all hours of the the day for the last few weeks and for initially accepting me to be supervised in-spite of not initially knowing what I wanted to create; I don't think many students have been able to do that and it provided the perfect environment to choose something I was passionate about. I'd never have thought of the Simulator without that leeway.\\
I really couldn't have been more fortunate in having both of you as my supervisors. I've learnt a lot not only from the project and autism but a lot in terms of research, methodology and practice. \\
I owe great thanks to my family who's strength, determination, boundless compassion and desire to understand others has and always will be a continual inspiration and in addition gave continual feedback throughout the project. And to my late Dad, Nan and Granddad. You were all big inspirations in so many different ways and were it not for any of you I'd not be in University.\\
Additionally I'd like to thank the JMonkey community. Inspite of the developers having a full time jobs, they are always working tirelessly to answer questions and help other members. JMonkey has been a pleasure to use! A special thanks in particular go to Normen and Chris.\\
Finally, i'd like to say a big thank-you to the autism community. You have all been fantastic, answering questions on forums providing great explanations and feedback. Throughout the development of this I have been fascinated and grown in admiration with every new piece of information I have acquired; I truly admire the day to day courage and strength you all share in tackling these difficulties. I hope that in some way this project can contribute in some way to increasing understanding and awareness of the challenges you experience in a day to day life.\\
\end{abstract}
